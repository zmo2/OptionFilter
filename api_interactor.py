...
def request_etrade_token(url):
	...
	signature = etrade_signature(CONS_SECRET, access_secret, 'GET', url, headers)
...
def get_access_token(url, oauth_token, oauth_token_secret, oauth_verifier):
	...
	signature = etrade_signature(CONS_SECRET, oauth_token_secret, 'GET', url, headers)
...
def create_authorization_header(base_url, access_token, access_secret, params={}):
	...
	signature = etrade_signature(CONS_SECRET, access_secret, 'GET', base_url, headers)
...
def get_option_chain_data(symbol, access_token, access_secret, sandbox=True, json=True):
	...
	authorization = create_authorization_header(url, access_token, access_secret, params=params)
...
if __name__ == "__main__":
	...
	access_token, access_secret = get_access_token(token_url, token, token_secret, verification_code)
	symbol = 'AAPL'
